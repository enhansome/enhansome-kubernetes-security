...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,965 | 🐛 274 | 🌐 Go | 📅 2026-09-17 - A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
* [kubescape](https://github.com/kubescape/kubescape) ⭐ 11,729 | 🐛 48 | 🌐 Go | 📅 2026-09-17 - k8s risk analysis, security compliance, and misconfiguration scanning.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,390 | 🐛 43 | 🌐 C++ | 📅 2026-09-17 - Container Native Runtime Security
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,189 | 🐛 106 | 🌐 Go | 📅 2026-09-07 - Check whether Kubernetes is deployed according to security best practics
* [steampipe](https://github.com/turbot/steampipe) ⭐ 7,955 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Use SQL to query your cloud services (AWS, Azure, GCP and more) running Kubernetes
...
* [trivy-operator](https://github.com/aquasecurity/trivy-operator) ⭐ 1,943 | 🐛 219 | 🌐 Go | 📅 2026-09-16 - Kubernetes-native security (Vulnerabilities,IaC MisConfig,Exposed Secrets,RBAC Assessment,Compliance and more) toolkit for kubernetes
...
* [kubectl-who-can](https://github.com/aquasecurity/kubectl-who-can) ⭐ 920 | 🐛 15 | 🌐 Go | 📅 2024-07-17 - Show who has permissions to \<verb> \<resource> in Kubernetes
...
* [kubernetes-rbac-audit](https://github.com/cyberark/kubernetes-rbac-audit) ⭐ 222 | 🐛 10 | 🌐 Python | 📅 2024-02-05 - Tool for auditing RBACs in Kubernetes
...
* [steampipe-kubernetes](https://github.com/turbot/steampipe-plugin-kubernetes) ⭐ 64 | 🐛 9 | 🌐 Go | 📅 2026-09-17 - Use SQL to query your Kubernetes resources
