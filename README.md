...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,529 | 🐛 254 | 🌐 Go | 📅 2026-08-20 - A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
* [kubescape](https://github.com/kubescape/kubescape) ⭐ 11,672 | 🐛 89 | 🌐 Go | 📅 2026-08-20 - k8s risk analysis, security compliance, and misconfiguration scanning.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,288 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Container Native Runtime Security
...
* [steampipe](https://github.com/turbot/steampipe) ⭐ 7,919 | 🐛 18 | 🌐 Go | 📅 2026-08-18 - Use SQL to query your cloud services (AWS, Azure, GCP and more) running Kubernetes
* [Deepfence ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,314 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01 - Apache v2, powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless
...
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,077 | 🐛 82 | 🌐 Python | 📅 2024-03-19 - Hunt for security weaknesses in Kubernetes clusters
* [CDK](https://github.com/cdk-team/CDK) ⭐ 4,735 | 🐛 15 | 🌐 Go | 📅 2026-05-01 - Zero Dependency Container Penetration Toolkit
...
* [trivy-operator](https://github.com/aquasecurity/trivy-operator) ⭐ 1,926 | 🐛 209 | 🌐 Go | 📅 2026-08-09 - Kubernetes-native security (Vulnerabilities,IaC MisConfig,Exposed Secrets,RBAC Assessment,Compliance and more) toolkit for kubernetes
...
* [kubectl-kubesec](https://github.com/stefanprodan/kubectl-kubesec) ⭐ 519 | 🐛 12 | 🌐 Go | 📅 2025-01-23 - Scan Kubernetes pods, deployments, daemonsets and statefulsets with kubesec.io
...
* [kubelight - WIP but promising](https://github.com/OWASP/KubeLight) ⭐ 108 | 🐛 7 | 🌐 Python | 📅 2023-06-06 - OWASP project to scan your Kubernetes Cluster for Security & Compliance.
* [steampipe-kubernetes](https://github.com/turbot/steampipe-plugin-kubernetes) ⭐ 64 | 🐛 10 | 🌐 Go | 📅 2026-07-29 - Use SQL to query your Kubernetes resources
...
* [CKS Certified Kubernetes Security Specialist resources repo](https://github.com/walidshaari/Certified-Kubernetes-Security-Specialist) ⭐ 2,122 | 🐛 0 | 🌐 AGS Script | 📅 2026-03-14
